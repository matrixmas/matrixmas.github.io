        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Produk Kami Telah Terjual Secara Nasional</h3>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600">Kami menawarkan berbagai pilihan produk berkualitas tinggi, dirancang untuk memenuhi berbagai kebutuhan keamanan kebakaran Anda. Dengan mengutamakan bahan terbaik, setiap produk kami memberikan perlindungan maksimal dan daya tahan yang handal.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <AlertTriangle className="h-12 w-12 text-red-600 mb-4" />
              <h3 className="text-xl font-semibold mb-2">Layanan Dukungan Kapan Saja</h3>
              <p className="text-gray-600">Kami selalu siap memberikan bantuan untuk kebutuhan darurat Anda. Dengan layanan yang tersedia setiap hari, kami memastikan keamanan dan kenyamanan Anda tanpa henti. Tim profesional kami siap memberikan solusi cepat dan tepat saat dibutuhkan.</p>
            </div>
          </div>
        </div>
      </section>
