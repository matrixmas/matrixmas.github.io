...
features: [
  "Tidak berwarna, tidak korosi, dan non-conductive pada peralatan elektronik",
  "Menggunakan agen pembersih (Clean Agent) yang ramah lingkungan",
  "Memiliki Zero ODP (Tidak merusak lapisan ozon)",
  "Efektif untuk memadamkan api kelas A, B, C, dan E dengan cara yang efisien dan cepat",
  "Mudah digunakan dan dilengkapi dengan bracket untuk dipasang di dinding",
  "Tersertifikasi UL dan memiliki garansi 6 tahun"
],
specifications: {
  capacity: "All Available",
}
  },
  {
    id: 2,
