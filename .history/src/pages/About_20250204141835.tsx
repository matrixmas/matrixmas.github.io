      ...
      <div className="py-12">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl font-bold text-gray-900 mb-8">Mengenai Matrix Fire Exta</h1>
            
            <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
              <h2 className="text-2xl font-bold mb-4">Pengalaman Kita</h2>
              <p className="text-gray-600 mb-6">
              Produk kami berkualitas tinggi dan ditawarkan kepada semua klien kami dengan harga yang menakjubkan yang tidak dapat dikalahkan. Dengan memilih MATRIX MAS sebagai preferensi, Anda mendapatkan produk yang Anda butuhkan saat Anda membutuhkannya. Beritahu kami produk seperti apa yang ingin Anda beli untuk rumah atau kantor Anda dan dengan senang hati kami akan menganjurkan Anda tentang apa yang paling sesuai dengan kebutuhan Anda saat ini.
              </p>
