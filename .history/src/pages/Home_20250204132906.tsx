        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">Semua produk kami telah memenuhi standar keselamatan yang ditetapkan oleh Standar Nasional Indonesia (SNI), memastikan kualitas dan keandalan yang dapat dipercaya untuk kebutuhan Anda.
