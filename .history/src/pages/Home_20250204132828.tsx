        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">Semua produk kami memenuhi standar keselamatan Standar Nasional Indonesia (SNI).</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="bg-red-100 p-4 rounded-full mb-4">
                <Clock className="h-8 w-8 text-red-600" />
              </div>
              <h3 className="text-xl font-semibold mb-2">Dukungan 24/5</h3>
              <p className="text-gray-600">Toko kami beroperasi setiap hari Senin hingga Jumat, siap memenuhi kebutuhan Anda dengan layanan yang cepat dan responsif. Kami memberikan dukungan penuh selama jam operasional untuk memastikan Anda mendapatkan pelayanan terbaik.
