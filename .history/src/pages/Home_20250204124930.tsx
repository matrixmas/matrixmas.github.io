    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="relative h-[600px]">
        ...
        <div className="relative z-20 container mx-auto px-6 pt-32">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl">Professional fire safety equipment and services. Protecting lives and properties with state-of-the-art fire extinguishers and expert consultation.</p>
