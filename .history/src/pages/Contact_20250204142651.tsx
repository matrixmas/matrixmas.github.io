...
export default function Contact() {
  ...
  <div className="w-full h-[400px] rounded-lg overflow-hidden">
    <iframe
      src="https://www.google.com/maps/dir//Jl.+Cipunegara+No.45,+Darmo,+Kec.+Wonokromo,+Surabaya,+Jawa+Timur+60241,+Indonesia/@-7.2928312,112.6484411,12z/data=!4m8!4m7!1m0!1m5!1m1!1s0x2dd7fbbfd56e1219:0x6c3c14d9a349cca0!2m2!1d112.730843!2d-7.2928387?entry=ttu&g_ep=EgoyMDI1MDIwMi4wIKXMDSoASAFQAw%3D%3D"
      width="100%"
      height="100%"
      style={{ border: 0 }}
      allowFullScreen
