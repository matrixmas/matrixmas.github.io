                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">085104820001</p>
                      <p className="text-gray-600">Emergency: (555) 911-FIRE</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@fireguardpro.com</p>
                      <p className="text-gray-600">support@fireguardpro.com</p>
                    </div>
                  </div>
                  <div className="flex items-start">
