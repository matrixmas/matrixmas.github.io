...
features: [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1629814210609-0d984e86bfb8?auto=format&fit=crop&q=80",
    description: "Ideal untuk kebakaran listrik dan area peralatan sensitif.

CO2 (Carbon Dioxide) Fire Extinguisher sangat efektif untuk memadamkan kebakaran pada peralatan elektronik dan mesin sensitif, di mana penggunaan air atau bahan kimia lainnya dapat menyebabkan kerusakan. Dengan kemampuan untuk menghilangkan oksigen di area kebakaran, alat pemadam ini memadamkan api dengan cepat tanpa meninggalkan residu. Ini membuatnya pilihan yang sempurna untuk lingkungan seperti ruang server, laboratorium, dan ruang komputer, di mana kebakaran dapat menimbulkan kerusakan besar pada perangkat elektronik.",
    features: [
      "Non-konduktif",
